...
$rstaff = new C_AccountController();

if(isset($_POST['login_btn'])){
  $rstaff->C_AccountLogin();
}
      ...
      <form action="" method="POST">
        ...
        <table>
          <tr>
            ...
            <td><input type="text" name="rs_email" required><br><br></td>
          </tr>

          <tr>
            <td>Password <br><br></td>
            <td><input type="password" name="rs_password" required minlength="8" maxlength="15"><br><br></td>
          </tr>
