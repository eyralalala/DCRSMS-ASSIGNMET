...
<tr>
<td>
<form method="post" action="riderHomepage.php"><input type="submit" name="decline" value="DECLINE">
<input style="background: #336699" type="submit" name="CONFIRM" value="CONFIRM" formaction="deliveryStart.php"></td>
</tr>
			<?php $count=$count+1;
        	echo "</tr>";
        	}
